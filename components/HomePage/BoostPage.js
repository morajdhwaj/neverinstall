...
const BoostPage = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `url(/boostbg.png)`,
        // width: "100",
        // height: "100",
      }}
    >
      <div className=" flex max-w-6xl m-auto">
        <div className="w-2/5 flex flex-col justify-end px-10 space-y-5 pl-20 pb-5 ">
          ...
          <div className="text-xl font-medium bg-gradient-to-br  from-emerald-300 to-pink-200 bg-clip-text text-transparent">
            <a>Try fast dev tools now</a>
          </div>
        </div>
        <div className="w-3/5   rounded-3xl bg-gradient-to-bl from-[#1a5e77] to-[#1c8ea8]">
